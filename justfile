...
continue:
    python.exe .\train_agents.py --timesteps 100000000 --resume-from .\training_logs\checkpoints

continuev:
    python.exe .\train_agents.py --timesteps 1000000 --resume-from .\training_logs\checkpoints --mode visual

eval:
    python.exe .\eval.py --from .\training_logs\checkpoints\ppo_2500000_steps.zip --mode visual --steps 10000